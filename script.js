...
// Para mouse (desktop)
stickerEl.addEventListener("mousedown", activateScissors);
stickerEl.addEventListener("mouseup", deactivateScissors);
stickerEl.addEventListener("mouseleave", deactivateScissors);

// Para toque (mobile)
stickerEl.addEventListener("touchstart", activateScissors);
stickerEl.addEventListener("touchend", deactivateScissors);
stickerEl.addEventListener("touchcancel", deactivateScissors);
